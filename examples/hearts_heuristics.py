''' A toy example of playing Hearts with 1 heuristic and 3 random agents
'''

import rlcard
from rlcard.agents.random_agent import RandomAgent
from rlcard.agents.heuristic_agent import HeuristicAgent
...
# Set up agents
agent_0 = HeuristicAgent(action_num=env.action_num)
